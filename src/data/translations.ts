...
export const TRANSLATIONS: Translation[] = [
  ...
  },
  {
    ...
    denominationIds: ['islam'],
    license: 'public-domain',
    attribution: 'Translation by M.H. Shakir. Served via AlQuran.cloud API.',
    apiProvider: 'alquran.cloud',
    apiTranslationId: 'en.shakir',
    notes: 'More literal rendering. Formerly Quran.com resource ID 24 -- that ID was removed from Quran.com v4; now served via AlQuran.cloud edition en.shakir.',
  },
  {
    id: 'sefaria-en',
